            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                ...
                >
                        ...
                        <template v-else>
                            <div class="relative w-full h-full flex flex-col justify-center items-center overflow-hidden">
                                ...
                                <div class="relative z-10">
                                    ...
                                    <div class="relative">
                                        <!-- Back paper -->
                                        <div class="absolute -top-2 -right-2 w-20 h-24 bg-gray-700 rounded-sm transform rotate-3"></div>
                                        <!-- Middle paper -->
                                        <div class="absolute -top-1 -right-1 w-20 h-24 bg-gray-600 rounded-sm transform rotate-2"></div>
                                        <!-- Front paper -->
                                        <div class="relative w-20 h-24 bg-white rounded-sm shadow-lg p-2 flex flex-col">
                                            <!-- Document lines -->
                                            ...
                                            <div class="mt-auto">
                                                <span :class="filterJenis === 'PPT' ? 'bg-orange-500' : 'bg-red-500'" 
                                                      class="text-white text-[8px] font-bold px-1.5 py-0.5 rounded">
                                                    {{ filterJenis }}
                                                </span>
                                            </div>
                                        </div>
                                ...
                                <p class="text-xs text-gray-400 mt-4 relative z-10">Dokumen Materi</p>
                            </div>
                        </template>
                    </div>
                    ...
                    <div class="p-4 flex flex-col justify-between h-auto">
                        <div>
                            <h3 class="text-black font-bold mb-1 line-clamp-2">{{ materi.judul }}</h3>
        ...
        <div v-if="showModal" class="fixed inset-0 z-50 overflow-y-auto bg-black/50 backdrop-blur-sm flex justify-center items-center p-4" @click.self="closeModal">
            <div class="bg-white rounded-lg w-full max-w-sm shadow-2xl transform transition-all duration-300 scale-100" @click.stop>
                ...
                <div class="px-6 pb-6 text-center">
                    ...
                    <div class="bg-gradient-to-br from-gray-50 to-gray-100 border-2 border-gray-200 h-48 mb-4 flex items-center justify-center rounded-lg mx-auto w-11/12 relative overflow-hidden">
                        ...
                        <div class="relative z-10 flex flex-col items-center">
                            <!-- Large document with details -->
                            <div class="relative">
                                <!-- Shadow documents behind -->
                                <div class="absolute -top-3 -left-3 w-28 h-36 rounded-lg transform -rotate-6 opacity-40"
                                     :class="selectedMateri?.file_type === 'pdf' ? 'bg-red-400' : 'bg-orange-400'"></div>
                                <div class="absolute -top-2 -right-2 w-28 h-36 rounded-lg transform rotate-6 opacity-40"
                                     :class="selectedMateri?.file_type === 'pdf' ? 'bg-red-400' : 'bg-orange-400'"></div>
                                
                                <!-- Main document -->
                                <div class="relative w-28 h-36 bg-white rounded-lg shadow-2xl border-2 border-gray-200 p-3 flex flex-col">
                                    <!-- Header with icon -->
                                    <div class="flex items-center justify-between mb-2">
                                        <div class="w-6 h-6 rounded flex items-center justify-center"
                                             :class="selectedMateri?.file_type === 'pdf' ? 'bg-red-100' : 'bg-orange-100'">
                                            <!-- PDF Icon -->
                                            <svg v-if="selectedMateri?.file_type === 'pdf'" class="w-4 h-4 text-red-600" fill="currentColor" viewBox="0 0 20 20">
                                                <path d="M4 4a2 2 0 012-2h4.586A2 2 0 0112 2.586L15.414 6A2 2 0 0116 7.414V16a2 2 0 01-2 2H6a2 2 0 01-2-2V4z"/>
                                            </svg>
                                            <!-- PPT Icon -->
                                            <svg v-else class="w-4 h-4 text-orange-600" fill="currentColor" viewBox="0 0 20 20">
                                    ...
                                    <div class="mt-2 text-center">
                                        <span class="text-[8px] text-gray-400 font-medium">Page 1</span>
                                    </div>
                                </div>
                            </div>
                            
                            <!-- File info badge -->
                            <div class="mt-4 px-3 py-1 rounded-full text-xs font-medium"
